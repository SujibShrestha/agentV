...
import { getCompanions, getUserSessions } from "@/lib/actions/companion.actions"
  ...
  return (
    <main className='min-lg:w-3/4 '>
      <section className="flex justify-between gap-4 max-sm:flex-col items-center">
        ...
        <Image src={user.imageUrl} alt={user.firstName!} className="rounded-full" width={110} height={110}/>
        ...
        <div className="flex gap-4">
          ...
          </div> <div className="border border-black rounded-lg p-3 gap-2 flex flex-col h-fit">
            <div className="flex gap-2 items-center">
